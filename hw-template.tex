...
\usepackage{graphicx,amssymb,amsmath,bm,color}
...
\newcommand{\homework}[4]{
	...
	\begin{center}
		\framebox{ \vbox{ \hbox to 6.28in
				{\bf ECON 4910: Industrial Organization \hfill #1} %change course name
				\vspace{4mm}
				\hbox to 6.28in
...
\homework{Fall 2021}{$X$}{Alex Shen (as5gd), Sean Velhagen (spv5hq), Max Bresticker (mtb9sex)}
