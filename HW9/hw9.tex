...
\item \begin{enumerate}
	...
	\end{align*}
	\solution{From this, we conclude that $p_1 = c_2$ if $c_2 \leq 5.5$ with firm 1 recieving profits $\pi_1 = (10-c_2)(c_2-1)$, otherwise $p_1 = 5.5$ and $\pi_1 = (10-5.5)(5.5-1) = 4.5^2$. In either case, firm 2 recieves no profits.}
	...
	\item Collusion is sustainable when both firms recieve a higher value from sticking to collusion than from cheating. The choice for both firms is between getting half the monopoly profit ($\pi^M = (10-5.5)(5.5-1) = 4.5^2$) forever, or the entire monopoly profit once and their Cournot equilibrium profit every round after that. 
	...
	\solution{$\delta \geq \frac{1}{2}$ and $\delta \geq \frac{\frac{1}{2}4.5^2}{4.5^2 - (10-c_2)(c_2-1)}$ where $2.32 \leq c_2 \leq 5.5$ }
\end{enumerate} 
